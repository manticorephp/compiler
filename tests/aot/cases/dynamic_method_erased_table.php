...
class ErasedAbiChild extends ErasedAbiBase {
    public function abi_m07(int $x): int { return $x + 70; }
}
function erased_abi_call(object $o, string $name, array $args): int {
    return $o->$name(...$args);
}
echo erased_abi_call(new ErasedAbiChild(), 'abi_m07', [2]), "\n";
