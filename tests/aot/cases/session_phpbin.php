...
// session.serialize_handler = php_binary, written and read back through the store, so
...
$dir = sys_get_temp_dir() . "/mc_sess_phpbin";
if (!is_dir($dir)) {
    mkdir($dir);
}
...
$out .= var_export(file_get_contents($dir . "/sess_encphpbin"), true) . "\n";
...
$out .= var_export(file_exists($dir . "/sess_encphpbin"), true) . "\n";
