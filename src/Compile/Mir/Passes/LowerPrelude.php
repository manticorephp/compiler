...
trait LowerPrelude
{
    ...
    private function preludeConstInt(string $name): ?Node
    {
        ...
        $ints = [
            ...
            'JSON_ERROR_DEPTH' => 1, 'JSON_ERROR_STATE_MISMATCH' => 2,
            'JSON_ERROR_CTRL_CHAR' => 3, 'JSON_ERROR_SYNTAX' => 4, 'JSON_ERROR_UTF8' => 5,
            'JSON_ERROR_RECURSION' => 6, 'JSON_ERROR_INF_OR_NAN' => 7,
            'JSON_ERROR_UNSUPPORTED_TYPE' => 8, 'JSON_ERROR_INVALID_PROPERTY_NAME' => 9,
            'JSON_ERROR_UTF16' => 10, 'JSON_ERROR_NON_BACKED_ENUM' => 11,
            // preg flags
