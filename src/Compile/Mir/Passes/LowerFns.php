...
trait LowerFns
{
    ...
    private function preludeProvidedNames(): array
    {
        return [
            ...
            'http_response_code', 'is_uploaded_file', 'iterator_apply', 'iterator_count', 'iterator_to_array',
            'krsort', 'ksort', 'move_uploaded_file', 'ob_clean', 'ob_end_clean',
            'ob_end_flush', 'ob_flush', 'ob_get_clean', 'ob_get_contents', 'ob_get_flush',
            'ob_get_length', 'ob_get_level', 'ob_get_status', 'ob_implicit_flush', 'ob_list_handlers',
            'ob_start', 'pack', 'register_shutdown_function', 'restore_error_handler', 'restore_exception_handler',
            'rsort', 'serialize', 'session_abort', 'session_cache_expire', 'session_cache_limiter',
            'session_commit', 'session_create_id', 'session_decode', 'session_destroy', 'session_encode',
            'session_gc', 'session_get_cookie_params', 'session_id', 'session_module_name', 'session_name',
            'session_regenerate_id', 'session_register_shutdown', 'session_reset', 'session_save_path', 'session_set_cookie_params',
            'session_set_save_handler', 'session_start', 'session_status', 'session_unset', 'session_write_close',
            'set_error_handler', 'set_exception_handler', 'setcookie', 'setrawcookie', 'shuffle',
            'sort', 'spl_autoload_functions', 'spl_autoload_register', 'spl_autoload_unregister', 'str_split',
            'timezone_location_get', 'timezone_name_get', 'timezone_offset_get', 'timezone_open', 'timezone_transitions_get',
            'uasort', 'uksort', 'unpack', 'unserialize', 'usort',
        ];
    }
