...
trait InferNarrow
{
    ...
    private function astKindClass(string $kv): string
    {
        return match ($kv) {
            ...
            'DynamicStaticCall' => \Parser\Ast\DynamicStaticCall::class,
            'DynamicStaticMethodCall' => \Parser\Ast\DynamicStaticMethodCall::class, 'Expression' => \Parser\Ast\ExpressionStmt::class,
